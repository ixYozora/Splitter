...
public class ArchTests {
  ...
  @ArchTest
  static final ArchRule rule4 =
      classes().that().areAnnotatedWith(Controller.class).should().resideInAPackage("..web..");

  @ArchTest
  static final ArchRule rule5 =
      classes().that().areAnnotatedWith(Repository.class).should().resideInAPackage("..database..");

  @ArchTest
  static final ArchRule rule6 =
      noClasses()
          .that()
  ...
  @ArchTest
  static final ArchRule rule7 =
      slices()
          .matching("propra2.splitter.(*)..")
          .that(describe("are the domain slice", slice -> slice.getNamePart(1).equals("domain")))
          .should(ONE_AGGREGATE_ROOT_EXISTS);

  @ArchTest static final ArchRule rule8 = noClasses().should().beAnnotatedWith(Deprecated.class);

  @ArchTest
  static final ArchRule rule9 =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule onlyAggregateRootsArePublic =
      classes()
          .that()
